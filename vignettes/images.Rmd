...
Registry for terra-jupyter-bioconductor](https://console.cloud.google.com/gcr/images/broad-dsp-gcr-public/). 

- [Terra-Jupyter-Bioconductor](https://github.com/DataBiosphere/terra-docker/tree/master/terra-jupyter-bioconductor)
is based on R version 4.1 and Bioconductor version 3.13. The image is available at
`us.gcr.io/broad-dsp-gcr-public/terra-jupyter-bioconductor:1.0.15`. It can be
used by selecting the `Bioconductor` notebook runtime. See the
...
is based on R version 4.1 and Bioconductor version 3.13. The image is accessible at
`us.gcr.io/anvil-gcr-public/anvil-rstudio-bioconductor:3.13.1`. It can be used
by selecting a 'custom' notebook runtime and selecting the RStudio image under
'Community Maintained RStudio Environment (Verified Partners)'. See the
...
The image is accessible at `us.gcr.io/anvil-gcr-public/anvil-rstudio-bioconductor-devel:3.14.1`.
